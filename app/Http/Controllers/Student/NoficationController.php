...
class NoficationController extends Controller
{
    public function nofication_list(Request $request){
        ...
        $nofiC = Nofication::where('nofication_mine',md5(Session::get('student_id')))->get();
        $nofi3_count = $nofiC->count();
        ...
        return view('student.page.nofication.list')->with(compact('meta_desc','meta_title','url_canonical','list','nofi','nofi2','studentSS','nofi2_count','nofi3_count'));
    }
