...
class HomeController extends Controller
{
	public function index(Request $request){
		...
		return view('student.page.home')->with(compact('meta_desc','meta_title','url_canonical','category_post','post2','studentSS','nofi'));
	}
	...
	public function search(Request $request)
	{
		...
		return view('student.page.post.search')->with(compact('meta_desc','meta_title','url_canonical','category_post','search_product','studentSS','nofi'));
	}
}
