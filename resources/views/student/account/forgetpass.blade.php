						...
						<div class="col-lg-6">
							<div class="login-sec">
								<div class="sign_in_sec animated fadeIn current" id="tab-1" style="padding-top: 140px;">
									<h3>Xác nhận Email để đổi mật khẩu mới</h3>
									@php
									...
									@endphp
									<center>
										<form action="{{url('/xac-nhan-mail')}}" method="post">
											{{csrf_field()}}
											<div class="row">
												<div class="col-lg-12 no-pdd">
													<div class="sn-field">
														<input type="email" name="student_email" placeholder="....@vanlanguni.vn">
														<i class="fa fa-envelope"></i>
													</div>
												</div>
												<div class="col-lg-12 no-pdd">
													<center>
														<button type="submit" value="submit">Tiếp tục</button>
													</center>
												</div>
											</div>
										</form>
