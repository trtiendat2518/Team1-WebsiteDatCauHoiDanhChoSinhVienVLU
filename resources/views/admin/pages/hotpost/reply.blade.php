				...
				<div class="position-center">
					<form role="form" style="margin-bottom: 20px" >
						...
						<div class="form-group">
							...
							<textarea rows="6" type="text" name="post_code" class="form-control" style="white-space: pre-line; resize: none;" disabled>{{$post_detail->post_content}}</textarea>
						</div>
					</form>
				</div>
			</div>
		...
		<section class="panel">
			...
			<div class="panel-body">
				<div class="position-center">
					...
					<a href="{{url('/cau-hoi-dang-chu-y')}}" title="">
